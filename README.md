...
<p>
  <a href="https://drive.google.com/file/d/10BkjksQHpcE9Qlwp-dgt2M2kwoIiJjrZ/view?usp=sharing" style="text-decoration: none; display: flex; align-items: center;">
...
### [🤖 My AI/Machine Learning Projects](https://github.com/stars/GhaziBenHenia/lists/ai-machine-learning-projects)

### [</> My C++ Projects](https://github.com/stars/GhaziBenHenia/lists/c-projects)

### [💻⚙️ My Hardware Projects](https://github.com/stars/GhaziBenHenia/lists/hardware-projects)

---
## 👨‍💻 About Me
I am a highly motivated Systems Engineer with a solid foundation in Embedded Systems, Electrical Engineering, and Integrated Systems, holding multiple master’s degrees in these fields, which I obtained simultaneously. With experience in Machine Learning through various internships, I have developed ML models for real-world applications. I specialize in research and development across embedded systems and machine learning, with a focus on creating innovative solutions in both fields.

On my GitHub, you can find a collection of projects that I have developed, showcasing my ability to turn ideas into functional solutions for real-world challenges through code.
...
<details>
 <summary>👨‍💻 More on Ghazi's Academic and Professional Journey</summary>

<p>I initially began with a Preparatory Class for Engineering Schools, where I specialized in Mathematics and Physics. After successfully passing the national exam to enter engineering schools, I started my Electrical Engineering degree. In my first year, I performed well, but I felt the need to expand my knowledge in the field of Embedded Systems, so I simultaneously pursued a master's degree in that area. During my second year in engineering school, despite balancing two degrees, I continued to excel and was selected for a double diploma program at the University of Montpellier, France.</p>

<p>Alongside my studies, I completed multiple internships in Machine Learning and Software Development at companies from around the world, including Ansys, Muutaa, Smart Ways Innovation, and STEG.</p>
</details>
